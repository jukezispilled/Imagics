...
export default async function Navbar() {
  ...
  return (
    <div>
      <div className="flex px-16 py-[11px] justify-between items-center border-slate-200 border-b">
        ...
        <div className="flex gap-4 items-center">
          {!user && (
            <Link href="/login">
              <Button variant={"ghost"}><span className="whitespace-nowrap">Login / Signup</span></Button>
            </Link>
          )}
          {user && (
            <DropdownMenu>
