...
export default function ExplainerSection() {
  return (
    <div>
      <div className="w-[100.01%]">
          <div className="h-min">
            <div className="mb-8">
              <h2 className="text-[56px] font-extrabold text-center mb-10 bg-gradient-to-r from-blue-500 via-blue-300 via-sky-300 to-sky-200 bg-clip-text text-transparent">How it Works</h2>
              ...
              <div className="space-y-4">
                ...
                <img
                  ...
                  className="rounded-lg object-cover w-full md:w-3/4 mx-auto"
                />
              </div>
